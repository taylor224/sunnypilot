...
A_CRUISE_MAX_VALS = [2.0, 2.0,  1.856, 0.926, .57, .47,  .33,  .10]
A_CRUISE_MAX_BP =   [0.,  6.1,  8.,   11.,   20.,  25.,  30.,  40.]
A_CRUISE_MIN_VALS = [-0.021, -0.021, -0.064, -0.064, -0.15, -0.15, -0.22,  -0.22, -1.0, -1.0]
A_CRUISE_MIN_BP =   [0.,     3.11,   3.12,   9.,     9.01,  14.0,  14.01,  18.,   20.,  30.]
